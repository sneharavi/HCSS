...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="218">
  ...
  <tr>
   ...
   <table border="2" cellspacing="4" cellpading="6">
    <tr><th><font color="#330099">Name</th><th><font color="#330099">Credit Card No.</th><th><font color="#330099">Expiry Month</th><th><font color="#330099">Pin No.</th><th><font color="#330099">CVV No.</th></tr>
 ...
 if(session.getAttribute("accno")!=null)
 {
   ...
   try
   {
	   rs=stmt.executeQuery("select * from uva.credit where accno='"+accno+"' ");
	   while(rs.next())
	   {%>
<tr>
