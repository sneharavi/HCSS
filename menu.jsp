...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="218">
  <tr>
    ...
    <td width="41%" height="74"><font color="#5E6CBA" size="5"><b></b></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <font color="#FFFFFF"><b><a href="newaccount.jsp" style="text-decoration: none" target="_self">
    <font color="#FFFFFF">New Account</font></a></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#336699"><b>
    <font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </font><a style="text-decoration: none" href="deposit.jsp" target="_self">
    <font color="#FFFFFF">credit card details</font></a><font color="#FFFFFF">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a style="text-decoration: none" target="_self" href="withdraw.jsp">
    <font color="#FFFFFF">pan card details</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="transaction.jsp" style="text-decoration: none" target="_self"><font color="#FFFFFF">Transaction Details</font></a></font></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <b><a href="viewdetails.jsp" style="text-decoration: none" target="_self"><font color="#FFFFFF">View Details</font></a></font></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <tr>
  <td colspan="3"><%@ include file="index1.htm"%></td>
  </tr>
