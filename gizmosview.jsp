...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="218">
  ...
  <tr>
    ...
    <!--<b><a href="index.jsp" style="text-decoration: none" target="_self"><font color="#FFFFFF">Home</font></a></font></b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
    <a style="text-decoration: none"  target="_self" href="creditcardview.jsp">
