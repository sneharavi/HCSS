...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="218">
  ...
  <tr>
   ...
   <a style="text-decoration: none" target="_self" href="aadhaarview.jsp" >
    ...
    <font color="#AD8BFE">Tax Records</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <table border="2" cellspacing="4" cellpading="6">
    <tr><th><font color="#330099">Area.No.</th><th><font color="#330099">Div.No.</th><th><font color="#330099">C.M.C.Bill.No.</th><th><font color="#330099">Tax Type</th><th><font color="#330099">Address</th><th><font color="#330099">Sl.No.</th><th><font color="#330099">Category</th></tr>
 ...
 if(session.getAttribute("accno")!=null)
 {
   ...
   try
   {
	   rs=stmt.executeQuery("select * from uva.tax where accno='"+accno+"'");
	   while(rs.next())
	   {%>
  <tr>	
