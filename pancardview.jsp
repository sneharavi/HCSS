...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="218">
  ...
  <tr>
    ...
    <font color="#AD8BFE">PAN Card</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <table border="2" cellspacing="4" cellpading="6">
    <tr><th><font color="#330099">Name</th><th><font color="#330099">Father's Name</th><th><font color="#330099">Date Of Birth</th><th><font color="#330099">PAN No.</th>
 ...
 if(session.getAttribute("accno")!=null)
 {
   ...
   try
   {
	   rs=stmt.executeQuery("select * from uva.pancard where accno='"+accno+"'");
	   while(rs.next())
	   {%>
  <tr>
